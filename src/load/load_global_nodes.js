...
function getStackChart() {
  ...
  _stackChartCache = {
    ...
    '75': [
      { num_sections: 4, top_section_height: 21, btm_section_height: 21, int1_rp1_height: 21, int1_rp2_height: 21 }
    ], //6-3
    '78': [
      { num_sections: 4, top_section_height: 21, btm_section_height: 21, int1_rp1_height: 21, int1_rp2_height: 21 }, //6-6
    ],
    '81': [
      { num_sections: 4, top_section_height: 21, btm_section_height: 21, int1_rp1_height: 21, int1_rp2_height: 21 },//6-9
    ],
    '84': [
    ...
    '99': [
      { num_sections: 5, top_section_height: 21, btm_section_height: 21, int1_rp1_height: 21, int1_rp2_height: 21, int2_rp1_height: 21 }, //8-3
    ],
    '102': [
      { num_sections: 5, top_section_height: 21, btm_section_height: 21, int1_rp1_height: 21, int1_rp2_height: 21, int2_rp1_height: 21, },//8-6
    ],
    '105': [
    ...
    '123': [
      { num_sections: 6, top_section_height: 21, btm_section_height: 21, int1_rp1_height: 21, int1_rp2_height: 21, int2_rp1_height: 21, int2_rp2_height: 21, }, //10-3
    ],
    '126': [
